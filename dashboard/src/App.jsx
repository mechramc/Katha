...
import IngestTrigger from './screens/IngestTrigger'
import MemoryApproval from './screens/MemoryApproval'
import ConsentGrant from './screens/ConsentGrant'
    ...
    <div className="flex h-screen overflow-hidden">
      ...
      <aside className="w-64 flex-shrink-0 bg-slate-900 text-slate-200 flex flex-col">
        <div className="px-6 py-5 border-b border-slate-700">
          <h1 className="text-xl font-bold tracking-tight text-white">KATHA</h1>
          <p className="text-xs text-slate-400 mt-1">Cultural Memory Dashboard</p>
        </div>
